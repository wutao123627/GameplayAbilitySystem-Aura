...
void UTargetDataUnderMouse::Activate()
{
	...
	if (bIsLocallyControlled) {
		...
		AbilitySystemComponent.Get()->AbilityTargetDataSetDelegate(SpecHandle,GetActivationPredictionKey()).AddUObject(this,&UTargetDataUnderMouse::OnTargetDataReplicateCallback);
